...
public class MainMenu {
    ...
    public static void main(String[] args) {
     ...
     //   cars = userInventoryActions.carDatabase();
        cars=ReadAndWriteJson.writeJson(cars);
        cars =ReadAndWriteJson.readJson();
        do {
            try {
                ...
                System.out.println("Input is not in correct format!" + nbe.getMessage());
                simpleprompt();
                userInput = 0;
            }
            catch (Exception ex) {
    ...
    public static void confirmDelete() {
        System.out.println("Please enter Y to confirm delete or N to main menu: ");
    }
}
